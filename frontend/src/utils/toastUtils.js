...
export const showSuccessToast = (msg, options) =>
  toast.success(msg, { className: `${base} ${tint.success}`, ...opts(options) })

export const showErrorToast = (msg, options) =>
  toast.error(msg, { className: `${base} ${tint.error}`, ...opts(options) })

export const showInfoToast = (msg, options) =>
  toast.info(msg, { className: `${base} ${tint.info}`, ...opts(options) })

export const showWarningToast = (msg, options) =>
  toast.warning(msg, { className: `${base} ${tint.warning}`, ...opts(options) })

export const showToast = (msg, options) =>
  toast(msg, { className: base, ...opts(options) })
...
// keep your named helpers, now using the new styling
